...
#define NRF24L01_IRQ_RCC			RCC_APB2Periph_GPIOB
#define NRF24L01_IRQ_PORT			GPIOB
#define NRF24L01_IRQ_PORT_SOURCE	GPIO_PortSourceGPIOB
#define NRF24L01_IRQ_PIN_SOURCE		GPIO_PinSource9
#define NRF24L01_IRQ_PIN			GPIO_Pin_9
#define NRF24L01_IRQ_EXTI_LINE		EXTI_Line9
#endif
...
#define NRF24L01_CONFIG			0x38//((1 << NRF24L01_EN_CRC) | (0 << NRF24L01_CRCO))
